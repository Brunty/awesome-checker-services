...
| https://www.toptal.com/designers/colorfilter | Check pages for color accessibility. | Free |
...
| URL | Description | 💳 |
| --- | ----------- | -- |
| http://browsershots.org | Test websites on many browsers, platforms, and devices. | Free |
...
| https://saucelabs.com | Test apps and websites in many browsers. Can be integrated into CI workflows. | Free trial, free for open source projects, paid |
| https://testingbot.com | Test apps and websites in many browsers. Can be integrated into CI workflows. | Free trial, free for open source projects, paid |
...
| https://www.digwebinterface.com/ | Extensive web interface to dig for doing online DNS / nameserver queries. | Free and donations welcome |
...
| https://dnsviz.net/ | A DNS visualization tool, including a visual analysis of the DNSSEC authentication chain. | Free |
...
| https://www.viewdns.info/ | View DNS, IP, and MX information. | Free and paid plans |
...
| URL | Description | 💳 |
| --- | ----------- | -- |
| https://email-checker.net | Check email addresses and lists of email addresses for existence. | Free and paid plans |
...
| https://mxtoolbox.com/blacklists.aspx | The blacklist check will test a mail server IP address against over 100 DNS-based emails. | Free and paid plans |
| https://www.unlocktheinbox.com/mail-tester/ | Email Authentication and Configuration Tester. | Free and paid plans |
| https://verify-email.org | Verify if an email address and the mailbox behind it exist. | Free and paid plans |
...
| URL | Description | 💳 |
| --- | ----------- | -- |
| https://developers.google.com/web/tools/lighthouse/ | Useful for testing PWA's mobile friendliness etc but not exclusively mobile. | Free |
...
| https://crt.sh | Get an overview and information on assigned TLS certificates. | Free |
...
| https://hstspreload.org/ | Check if a domain is on the HSTS preload list in browsers and submit it to the list. | Free |
...
| https://www.zerobounce.com/ | Check to see if the email address is valid. | Free and paid plans |
...
| https://developers.google.com/speed/pagespeed/insights/ | PageSpeed Insights analyzes the content of a web page, and then generates suggestions to make that page faster. | Free |
...
| https://yellowlab.tools/ | Online test to help speed up heavy web pages. | Free |
